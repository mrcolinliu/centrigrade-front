...
import { ResearchAreaSummary, ResearchAreaType } from '../../../models/research/research.models';
import { ResearchService } from '../../../services/research.service';
import { ModalProvider } from '../../_shared/modal/modal.component';

@Component({
  selector: 'app-research-university',
  templateUrl: './research-university.component.html',
  styleUrls: ['./research-university.component.scss']
})
export class ResearchUniversityComponent implements OnInit {
  static route = 'research/university';
  ...
  private type: ResearchAreaType = 'institution';
  ...
  ngOnInit() {
    this.locale = this.localisation.getTranslationsForComponent('ResearchUniversityComponent');
